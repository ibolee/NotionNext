...
const BLOG = {
  ...
  KEYWORDS: '黑李白的博客, 黑李白', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: 'https://t.me/huoluo',
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'UA-186513243-1', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是黑李白的博客，可别关注错了。', // 站点描述，被notion中的页面描述覆盖
